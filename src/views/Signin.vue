            ...
            <div class="mx-auto col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form">
                    <div class="mb-3">
                      <ArgonInput id="email" type="email" placeholder="Email" name="email" size="lg" />
                    </div>
                    <div class="mb-3">
                      <ArgonInput id="password" type="password" placeholder="Password" name="password" size="lg" />
                    </div>
                    ...
                    <div class="text-center">
                      <ArgonButton class="mt-4" variant="gradient" color="success" full-width size="lg">
                        Sign
                        in
                      </ArgonButton>
                    </div>
