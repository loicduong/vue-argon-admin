          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <ArgonButton color="success" size="sm" class="ms-auto">
                  Settings
                </ArgonButton>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <ArgonInput type="text" value="lucky.jesse" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label">Email address</label>
                  <ArgonInput type="email" value="jesse@example.com" />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <ArgonInput type="text" value="Lucky" />
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <ArgonInput type="text" value="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09" />
                </div>
                <div class="col-md-4">
                  <label for="example-text-input" class="form-control-label">City</label>
                  <ArgonInput type="text" value="New York" />
                </div>
                <div class="col-md-4">
                  <label for="example-text-input" class="form-control-label">Country</label>
                  <ArgonInput type="text" value="United States" />
                </div>
                <div class="col-md-4">
                  <label for="example-text-input" class="form-control-label">Postal code</label>
                  <ArgonInput type="text" value="437300" />
                </div>
              </div>
              <hr class="horizontal dark">
              <p class="text-uppercase text-sm">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <ArgonInput type="text" value="A beautiful Dashboard for Bootstrap 5. It is Free and Open Source." />
                </div>
              </div>
            </div>
          </div>
