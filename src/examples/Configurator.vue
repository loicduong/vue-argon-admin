  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        ...
        <div class="mt-4" :class="isRTL ? 'float-start' : 'float-end'" @click="toggleConfigurator">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div class="my-2 badge-colors" :class="isRTL ? 'text-end' : ' text-start'">
            ...
            />
            <span class="badge filter bg-gradient-dark" data-color="dark" @click="sidebarColor('dark')" />
            <span class="badge filter bg-gradient-info" data-color="info" @click="sidebarColor('info')" />
            <span class="badge filter bg-gradient-success" data-color="success" @click="sidebarColor('success')" />
            <span class="badge filter bg-gradient-warning" data-color="warning" @click="sidebarColor('warning')" />
            <span class="badge filter bg-gradient-danger" data-color="danger" @click="sidebarColor('danger')" />
          </div>
        </a>
        <!-- Sidenav Type -->
        <div class="mt-3">
