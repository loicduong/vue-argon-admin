...
export default function setNavPills() {
  ...
  function initNavs() {
    total.forEach(function (item, i) {
      ...
      var tab = first_li?.cloneNode() as HTMLElement;
      tab.innerHTML = "-";
      ...
      item.addEventListener("mouseover", (event) => {
        ...
        let li = (target as HTMLElement)?.closest("li"); // get reference
        if (li) {
          ...
          (item.querySelector("li:nth-child(" + index + ") .nav-link") as HTMLElement).onclick =
            function () {
              ...
              if (item.classList.contains("flex-column")) {
                ...
                moving_div.style.width =
                  (item?.querySelector("li:nth-child(" + index + ")") as HTMLElement)?.offsetWidth + "px";
              }
            };
        }
      })
